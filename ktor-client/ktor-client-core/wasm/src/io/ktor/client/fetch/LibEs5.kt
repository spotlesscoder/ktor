...
public external interface Uint8Array : JsAny {
    ...
    public fun copyWithin(target: JsNumber, start: JsNumber, end: JsNumber? = definedExternally): Uint8Array /* this */
    public fun every(
    ...
    public fun reduce(
        callbackfn: (previousValue: JsNumber, currentValue: JsNumber, currentIndex: JsNumber, array: Uint8Array) -> JsNumber
    ): JsNumber
    public fun reduce(
        callbackfn: (previousValue: JsNumber, currentValue: JsNumber, currentIndex: JsNumber, array: Uint8Array) -> JsNumber,
    ...
    public fun <U : JsAny> reduce(
        callbackfn: (previousValue: U, currentValue: JsNumber, currentIndex: JsNumber, array: Uint8Array) -> U,
        initialValue: U
    ): U
...
@Suppress("UNUSED_PARAMETER")
internal fun setMethodImplForUint8Array(obj: Uint8Array, index: Int, value: Byte): Unit = js("obj[index] = value;")

public operator fun Uint8Array.set(index: Int, value: Byte): Unit = setMethodImplForUint8Array(this, index, value)
...
@Suppress("UNUSED_PARAMETER")
internal fun <T : JsAny?> getMethodImplForArrayLike(obj: ArrayLike<T>, index: Int): T = js("return obj[index];")

public operator fun <T : JsAny?> ArrayLike<T>.get(index: Int): T = getMethodImplForArrayLike(this, index)

@Suppress("UNUSED_PARAMETER")
internal fun <T : JsAny?> setMethodImplForArrayLike(obj: ArrayLike<T>, index: Int, value: T): Unit = js("obj[index] = value;")

public operator fun <T : JsAny?> ArrayLike<T>.set(index: Int, value: T): Unit = setMethodImplForArrayLike(this, index, value)
